	 ...
	 viewBox="0 0 725.1 350.6" style="enable-background:new 0 0 725.1 350.6;" xml:space="preserve">
      ...
      <div class="hmap__details">
        <div class="hmap__money-in">
          ...
          <div class="hmap__bank-accounts">
            <h3>Bank Accounts</h3>
            <div>
              <p>Jan. 1 {{ bankAccountTotals.startBalance }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ bankAccountTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__investments">
            <h3>Investments</h3>
            <div>
              <p>Jan. 1 {{ investmentTotals.startBalance }}</p>
            </div>
            <div>
              <p>In/Out {{ investmentTotals.inOut }}</p>
            </div>
            <div>
              <p>Up/Down {{ investmentTotals.upDown }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ investmentTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__college-savings">
            <h3>College Savings</h3>
            <div>
              <p>Jan. 1 {{ collegeSavingsTotals.startBalance }}</p>
            </div>
            <div>
              <p>In/Out {{ collegeSavingsTotals.inOut }}</p>
            </div>
            <div>
              <p>Up/Down {{ collegeSavingsTotals.upDown }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ collegeSavingsTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__retirement">
            <h3>Retirement Accounts</h3>
            <div>
              <p>Jan. 1 {{ retirementTotals.startBalance }}</p>
            </div>
            <div>
              <p>In/Out {{ retirementTotals.inOut }}</p>
            </div>
            <div>
              <p>Up/Down {{ retirementTotals.upDown }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ retirementTotals.endBalance }}</p>
            </div>
          </div>
        </div>
        <div class="hmap__money-out">
          <div class="hmap__mortgages">
            <h3>Mortgages</h3>
            <div>
              <p>Jan. 1 {{ mortgageTotals.startBalance }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ mortgageTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__student-loans">
            <h3>Student Loans</h3>
            <div>
              <p>Jan. 1 {{ studentLoanTotals.startBalance }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ studentLoanTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__credit-cards">
            <h3>Credit Cards</h3>
            <div>
              <p>Jan. 1 {{ creditCardTotals.startBalance }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ creditCardTotals.endBalance }}</p>
            </div>
          </div>
          <div class="hmap__auto-laons">
            <h3>Auto Loans</h3>
            <div>
              <p>Jan. 1 {{ autoLoanTotals.startBalance }}</p>
            </div>
            <div>
              <p>Dec. 31 {{ autoLoanTotals.endBalance }}</p>
            </div>
          </div>
        </div>
      </div>
